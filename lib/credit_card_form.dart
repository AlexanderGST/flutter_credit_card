...
class CreditCardForm extends StatefulWidget {
  const CreditCardForm({
    ...
    this.cvvValidationMessage = 'Ingrese un CVV válido',
    this.dateValidationMessage = 'Ingrese una fecha válida',
    this.numberValidationMessage = 'Ingrese un número válido',
    this.nameValidationMessage = 'El nombre de la tarjeta no debe exceder los 25 caracteres.',
    this.nameValidationMessageLength = 'El nombre de la tarjeta no debe exceder los 25 caracteres.',
  ...
  final String nameValidationMessageLength;
              ...
              child: Container(
                ...
                child: TextFormField(
                  ...
                  validator: (String? value) {
                    ...
                    }else if(_cardNumberController.text.substring(0,2) == "34" || _cardNumberController.text.substring(0,2) == "37"){
                      return "Únicamente puedes utilizar tarjetas Visa o Mastercard.";
                    }
                    return null;
                  },
                ),
